...
public partial class MainWindowViewModel : ObservableObject
{
    ...
    public MainWindowViewModel(ReceiptPrinter printer, IImageEncoder encoder,
        INotificationService notifications, IFileDialogService dialogs,
        string listenAddress = "0.0.0.0", int tcpPort = 9100,
